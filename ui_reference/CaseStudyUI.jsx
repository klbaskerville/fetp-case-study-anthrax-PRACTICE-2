...
export default function AnthraxCaseStudy() {
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-white p-3 rounded">
                ...
                <ul className="text-sm space-y-1">
                  ...
                  <li>• Less than 2% own television</li>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 p-4 rounded-lg space-y-3 mt-4">
            ...
            <div className="bg-blue-50 p-3 rounded border border-blue-200 mt-3">
              ...
              <p className="text-sm mt-2"><strong>Analysis result:</strong> Boiling meat for more than 60 minutes was protective (RR=0.49 compared to less than 60 minutes)</p>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg mt-4">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <p>Livestock vaccination, proper carcass disposal, cook meat thoroughly (boil more than 60 min), decontaminate sites</p>
              </div>
            </div>
          </div>
        </div>
